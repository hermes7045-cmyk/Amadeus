...
from amadeus.orchestration import RoleCardRegistry
from amadeus.orchestration.roles import DEFAULT_ROLE_PROMPT
...
class RoleCardRegistryTests(unittest.TestCase):
    def test_discover_creates_default_role_file(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            default_path = workspace / ".amadeus" / "roles" / "default.md"
    ...
    def test_workspace_default_role_has_highest_priority(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            workspace_roles = workspace / ".amadeus" / "roles"
