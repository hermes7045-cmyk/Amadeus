...
export const STAGE_EFFECTS_STORAGE_KEY = "amadeus.web.stage.effects.v3";
export const STAGE_BACKGROUND_STORAGE_KEY = "amadeus.web.stage.background";
export const LIVE2D_SELECTION_STORAGE_KEY = "amadeus.web.live2d.selection";
export const LIVE2D_HOTKEYS_STORAGE_KEY = "amadeus.web.live2d.hotkeys_enabled";
export const LIVE2D_MOUSE_FOLLOW_STORAGE_KEY = "amadeus.web.live2d.mouse_follow";
