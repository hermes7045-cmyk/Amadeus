...
const SETTINGS_PANEL_STORAGE_KEY = "amadeus.web.settings_panel_open";
const CRON_PANEL_STORAGE_KEY = "amadeus.web.cron_panel_open";
const HEARTBEAT_PANEL_STORAGE_KEY = "amadeus.web.heartbeat_panel_open";
const LIVE2D_PANEL_STORAGE_KEY = "amadeus.web.live2d_panel_open";
const RUNTIME_PANEL_STORAGE_KEY = "amadeus.web.runtime_panel_open";
const STAGE_BACKGROUND_PANEL_STORAGE_KEY = "amadeus.web.stage_background_panel_open";
const STAGE_EFFECTS_PANEL_STORAGE_KEY = "amadeus.web.stage_effects_panel_open";
